                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            {/* We build digital solutions to help businesses scale */}
                                Your Trusted Partner For Export to India and the Far East
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">Specialising in servicing suppliers and buyers of recovered or redundant paper, platic and metals in the UK, India and the rest of the world.</div>
