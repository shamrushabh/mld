            ...
            <div id='contact' className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 ">
                ...
                <form onSubmit={sendEmail}>
                            ...
                            <div className="flex flex-col text-white">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-gray-400">Total Commodities Ltd
                                        Devonshire House
                                        582 Honeypot Lane
                                        Stanmore, Middlesex
                                        HA7 1JS</p>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel:+44(0)2079980869</p>
                        
                            <div className='mt-5'>
                                <h2 className="text-2xl">Send an E-mail</h2>
                                <p className="text-gray-400">info@totalcommodities.com</p>
                            </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        <a href="https://www.linkedin.com/company/total-commodities-ltd/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8  mx-1 text-center pt-1">
